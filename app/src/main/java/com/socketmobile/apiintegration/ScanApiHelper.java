...
public class ScanApiHelper {
	...
	private Vector _devicesList;// maintain a list of connected device (current only one scanner at a time)
	 ...
	 */
	public void postGetScanAPIConfiguration(String configurationName,ICommandContextCallback callback)
	{
		ISktScanObject newScanObj=SktClassFactory.createScanObject();
	 ...
	 * retrieve the ScanAPI Configuration
	 */
	public void postSetScanAPIConfiguration(String configurationName,String value,ICommandContextCallback callback)
	{
		ISktScanObject newScanObj=SktClassFactory.createScanObject();
		newScanObj.getProperty().setID(ISktScanProperty.propId.kSktScanPropIdConfiguration);
		newScanObj.getProperty().setType(ISktScanProperty.types.kSktScanPropTypeString);
	...
	public void postGetCapabilitiesDevice(DeviceInfo deviceInfo,ICommandContextCallback callback)
	{
		...
		newScanObj.getProperty().setType(ISktScanProperty.types.kSktScanPropTypeByte);
		newScanObj.getProperty().setByte((char) values.capabilityGroup.kSktScanCapabilityLocalFunctions);
	...
	public void postSetDecodeAction(DeviceInfo device,int decodeVal,ICommandContextCallback callback)
	{
		...
		CommandContext command=new CommandContext(false, newScanObj, device.getSktScanDevice(),null, callback);
		addCommand(command);
	}
	...
	public void postSetProfileConfigDevice(DeviceInfo device, String hostAddress,ICommandContextCallback callback) {
		...
		newScanObj.getProperty().setType(SktScan.helper.SKTRETRIEVESETTYPE(ISktScanProperty.propId.kSktScanPropIdProfileConfigDevice));
		...
		CommandContext command=new CommandContext(false, newScanObj,device.getSktScanDevice(),device, callback);
		addCommand(command);
	}
	...
	public void postSetDisconnectDevice(DeviceInfo device, ICommandContextCallback callback) {
		...
		newScanObj.getProperty().setType(SktScan.helper.SKTRETRIEVESETTYPE(ISktScanProperty.propId.kSktScanPropIdDisconnectDevice));
		newScanObj.getProperty().setByte((char) values.disconnect.kSktScanDisconnectStartProfile);
	...
	public void postGetTimersDevice(DeviceInfo device, ICommandContextCallback callback) {
		...
		newScanObj.getProperty().setType(SktScan.helper.SKTRETRIEVEGETTYPE(ISktScanProperty.propId.kSktScanPropIdTimersDevice));

		CommandContext command=new CommandContext(true, newScanObj,device.getSktScanDevice(),device, callback);
		addCommand(command);
	}
	 ...
	 */
	public void postSetTimersDevice(DeviceInfo device, int timerMask,int lockOutTimer,int disconnectedAutoOff,int connectedAutoOff,ICommandContextCallback callback) {
		ISktScanObject newScanObj=SktClassFactory.createScanObject();
		newScanObj.getProperty().setID(ISktScanProperty.propId.kSktScanPropIdTimersDevice);
		newScanObj.getProperty().setType(SktScan.helper.SKTRETRIEVESETTYPE(ISktScanProperty.propId.kSktScanPropIdTimersDevice));
	 ...
	 */
	public void postGetSoundConfigDevice(DeviceInfo device,int soundAction,ICommandContextCallback callback){
	 ...
	 * a triplet array containing 3 shorts for respectively the frequency (low, medium, high), duration and pause.
	 */
	public void postSetSoundConfigDevice(DeviceInfo device,int soundAction,short[] soundConfig,ICommandContextCallback callback){
	...
	private void ConvertStringtoCharArray(char[] destination,int destinationOffset,String source){
