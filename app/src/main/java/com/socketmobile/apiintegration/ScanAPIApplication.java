package com.socketmobile.apiintegration;
 ...
 * SoftScan is a scanner that uses the device camera. It requires Barcode Scanner 
 * (ZXing) application to be installed on the device.
 * SoftScan provides the same interface as any Socket Scanner, and the decoded
 * data are received by the same onDecodedData notification than the other scanners.
 *
 * By default SoftScan is configured as "NOT SUPPORTED". In order to support it in
 * your application, you will need first to get SoftScan Status, and if it says
 * "not supported" you can set it to "supported". By doing so, the status becomes
 * disabled. At this point you can set the status to enabled, and as soon as this
 * is successful, a device Arrival notification is received with the SoftScan device
 * info.
 *
 * Once you receive this notification you should set the overlay view with your 
 * activity context. We recommend to do this right after receiving the device Arrival
 * for SoftScan.
 *
 * Now that the overlay view has been set, you can trigger a scan, (usually done by
 * having a trigger button in the UI, and calling a Set Trigger property with start
 * as parameter).
 *
 * As soon as the trigger has completed, the Barcode Scanner (ZXing) app appears on
 * the screen and you can scan a barcode.
 *
 ...
 *
 * 2) It is better to check if the Barcode Scanner (ZXing) app is installed before enabling
 * or trying to use SoftScan. There is no practical way for ScanAPI to do this, and if you
 * try anyway to use SoftScan while Barcode Scanner (ZXing) app is not installed, you'll
 * end up getting an error -27 (unable open device) while triggering SoftScan.
 *
 * @author EricG
 *
 */
public class ScanAPIApplication extends Application {
    ...
    public static final String START_EZ_PAIR=ScanAPIApplication.class.getName()+".StartEzPair";
    public static final String STOP_EZ_PAIR=ScanAPIApplication.class.getName()+".StopEzPair";
    public static final String NOTIFY_EZ_PAIR_COMPLETED=ScanAPIApplication.class.getName()+".NotifyEzPairCompleted";
    public static final String EXTRA_EZ_PAIR_DEVICE=ScanAPIApplication.class.getName()+".EzPairDevice";
    public static final String EXTRA_EZ_PAIR_HOST_ADDRESS=ScanAPIApplication.class.getName()+".EzPairHostAddress";

    // to manage the sound configuration for the data confirmation beep
    public static final String SET_DATA_CONFIRMATION=ScanAPIApplication.class.getName()+".SetDataConfirmation";
    public static final String GET_SOUND_CONFIG=ScanAPIApplication.class.getName()+".GetSoundConfig";
    public static final String SET_SOUND_CONFIG=ScanAPIApplication.class.getName()+".SetSoundConfig";
    public static final String GET_SOUND_CONFIG_COMPLETE=ScanAPIApplication.class.getName()+".GetSoundConfigComplete";
    public static final String SET_SOUND_CONFIG_COMPLETE=ScanAPIApplication.class.getName()+".SetSoundConfigComplete";
    public static final String EXTRA_SOUND_CONFIG_FREQUENCY=ScanAPIApplication.class.getName()+".SoundConfigFrequency";
    ...
    public static final String GET_SOFTSCAN_COMPLETE=ScanAPIApplication.class.getName()+".GetSoftScanComplete";
    public static final String SET_SOFTSCAN_COMPLETE=ScanAPIApplication.class.getName()+".SetSoftScanComplete";
    public static final String SET_TRIGGER_COMPLETE=ScanAPIApplication.class.getName()+".SetTriggerComplete";
    public static final String SET_OVERLAYVIEW_COMPLETE=ScanAPIApplication.class.getName()+".SetOverlayViewComplete";

    public static final String NOTIFY_SCANPI_INITIALIZED = ScanAPIApplication.class.getName() + ".NotifyScanApiInitialized";
    public static final String NOTIFY_SCANNER_ARRIVAL = ScanAPIApplication.class.getName() + ".NotifyScannerArrival";
    public static final String NOTIFY_SCANNER_REMOVAL = ScanAPIApplication.class.getName() + ".NotifyScannerRemoval";
    public static final String NOTIFY_DECODED_DATA = ScanAPIApplication.class.getName() + ".NotifyDecodedData";
    public static final String NOTIFY_ERROR_MESSAGE=ScanAPIApplication.class.getName()+".NotifyErrorMessage";
    public static final String NOTIFY_CLOSE_ACTIVITY=ScanAPIApplication.class.getName()+".NotifyCloseActivity";

    public static final String EXTRA_SOFTSCAN_STATUS=ScanAPIApplication.class.getName()+".SoftScanStatus";
    public static final String EXTRA_ISSOFTSCAN=ScanAPIApplication.class.getName()+".IsSoftScan";
    public static final String EXTRA_ERROR=ScanAPIApplication.class.getName()+".Error";
    public static final String EXTRA_ERROR_MESSAGE=ScanAPIApplication.class.getName()+".ErrorMessage";
    public static final String EXTRA_DEVICENAME=ScanAPIApplication.class.getName()+".DeviceName";
    public static final String EXTRA_SYMBOLOGY_NAME=ScanAPIApplication.class.getName()+".SymbologyName";
    public static final String EXTRA_DECODEDDATA=ScanAPIApplication.class.getName()+".DecodedData";
    ...
    protected ICommandContextCallback _onGetSoundConfigDevice=new ICommandContextCallback() {
        ...
        public void run(ISktScanObject scanObj) {
            ...
            if(SktScanErrors.SKTSUCCESS(result)){
                ...
                else if(freq==ISktScanProperty.values.soundFrequency.kSktScanSoundFrequencyLow){
        ...
        public void onReceive(Context context, Intent intent) {
            if(intent.getAction().contains(START_EZ_PAIR)){
                ...
                if(frequency.contains(SOUND_CONFIG_FREQUENCY_MEDIUM)){
                    soundConfig[0]=ISktScanProperty.values.soundFrequency.kSktScanSoundFrequencyMedium;
                }
                else if(frequency.contains(SOUND_CONFIG_FREQUENCY_LOW)){
                    soundConfig[0]=ISktScanProperty.values.soundFrequency.kSktScanSoundFrequencyLow;
                }
    ...
    public static ScanAPIApplication getApplicationInstance(){
        return _singleton;
    }
    ...
    private ScanApiHelperNotification _scanApiHelperNotification=new ScanApiHelperNotification() {
        ...
        public void onDeviceRemoval(DeviceInfo deviceRemoved) {
            if(_ezPairInProgress==false){
                ...
                if(deviceRemoved.getTypeString()=="Soft Scanner"){
        ...
        public void onDeviceArrival(long result, DeviceInfo newDevice) {
            ...
            if(SktScanErrors.SKTSUCCESS(result)){
                if(_ezPairInProgress==false){
                    ...
                    if(newDevice.getTypeString()=="Soft Scanner"){
    ...
    protected ICommandContextCallback _onGetScanApiConfiguration=new ICommandContextCallback() {
        ...
        public void run(ISktScanObject scanObj) {
            ...
            if(SktScanErrors.SKTSUCCESS(result)){
                ...
                if(_originalScanAPIConfiguration.toLowerCase(Locale.US).contains("server")==false){
